...
Fully configurable spreadsheet view with user interfaces for iOS applications. With this framework, you can easily create complex layouts like schedules, Gantt charts and timetables as if you are using Excel.
